...
# -----------------------------
INTRO = [
    """2019 war das 30. Jubiläum der Friedlichen Revolution. Doch ungetrübte Feierstimmung wollte nicht aufkommen. Der Mord an Walter Lübcke, der Anschlag von Halle und die Umfrageergebnisse der AfD prägten die Debatten. Das Erbe der Friedlichen Revolution, so schien es, musste neu verhandelt werden.""",
...
Essay</a> 
des Rappers Hendrick Bolz auf Twitter. Es beschreibt eine von rechter Gewalt geprägte Jugend im Ostdeutschland der Nachwendezeit. Eine Generationenerfahrung.""",
    """Hunderte Nutzer*innen folgten dem Aufruf Bangels und teilten ihre autobiographischen Erinnerungen unter dem Hashtag #Baseballschlägerjahre. Für meine Masterarbeit habe ich diese Tweets gesammelt und ausgewertet. In dieser Webapp mache ich die Geschichten zugänglich."""
]
